...
public class AppMain {
    ...
    private static JSONObject generateNewsDetail() {
        ...
        // 商品id
        appNewsDetail.setGoodIds(sGoodSid + "");
        ...
        appNewsDetail.setNewsStayTime(flag + "");

        // 加载时长
        flag = rand.nextInt(10) * rand.nextInt(7);
        appNewsDetail.setLoadingTime(flag + "");
    ...
    private static JSONObject generateAd() {
        ...
        // 商品类型
        flag = rand.nextInt(10);
        appAd.setNewTypes("" + flag);

        // 展示样式
        flag = rand.nextInt(6);
        appAd.setShowStyle("" + flag);
    ...
    private static JSONObject generateNotification() {
        ...
        // 客户端弹时间
        appNotification.setApTime((System.currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject generatbeforeground() {
        ...
        appActive_foreground.setPushId(flag + "");
    ...
    private static JSONObject generateBackground() {
        ...
        // 启动源
        int flag = rand.nextInt(3) + 1;
        appActive_background.setActiveSource(flag + "");
