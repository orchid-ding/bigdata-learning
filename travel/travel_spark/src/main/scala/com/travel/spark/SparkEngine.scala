...
object SparkEngine {
  /*def getSparkConf():SparkConf = {
    ...
    val sparkConf: SparkConf = new SparkConf()
      ...
      .set("spark.task.macFailures" , GlobalConfigUtils.getProp("spark.task.maxFailures"))
      .set("spark.speculation" , GlobalConfigUtils.getProp("spark.speculation"))
      .set("spark.driver.allowMutilpleContext" , GlobalConfigUtils.getProp("spark.driver.allowMutilpleContext"))
      .set("spark.serializer" , GlobalConfigUtils.getProp("spark.serializer"))
      .set("spark.buffer.pageSize" , GlobalConfigUtils.getProp("spark.buffer.pageSize"))
      ...
      .set("spark.buffer.pageSize" , "250m")
